...
class TestDeserializationUint32 < Test::Unit::TestCase
  ...
  def test_two_uint32
    ...
    deserialized = Deserializer.deserialize(byte_sequence, [:uint32, :uint32])
    assert_equal [[max_value, max_value], ''], deserialized
  end
  ...
  def test_two_uint8_2
    ...
    deserialized = Deserializer.deserialize(byte_sequence, [:uint32])

    assert_equal [[max_value], rest], deserialized
  end
end
